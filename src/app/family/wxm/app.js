define([
    ...
    appRun.$inject = ['$location', 'splash', 'httpRequest', 'settingCache', 'CONSTANT', 'CONSTANT_UTILS'];

    function appRun($location, splash, httpRequest, settingCache, constant, utils) {
        // attach fastclick
        ...
        function registerWeixin() {
            httpRequest.getReq('/sns/weixin/get_jsapi_config.json', {
                type: 'llq'
            }, {
                ignoreLogin: true
            }).then(function (data) {
