...
define([
    ...
    module.controller('SharePreFriendsCtrl', SharePreFriends);

    ////////
    SharePreFriends.$inject = [
        '$rootScope',
        '$scope',
        '$location',
        '$stateParams',
    ...
    function SharePreFriends($rootScope, $scope, $location, $stateParams, $q, $window, settingCache, httpRequest, urlHelper, utils, urlPrefix) {
        var vm = $scope;
        ...
        function loadItems() {
            ...
            httpRequest.getReq(urlHelper.getUrl('getHistoryFriendslist'), params)
                .then(function (d) {
                    pageIndex++;
