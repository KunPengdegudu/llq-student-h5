/*!
 * add $sce filter,edited by chenmingwei
 * 
 * ngToast v1.3.0 (http://tameraydin.github.io/ngToast)
 * Copyright 2014 Tamer Aydin
 * Licensed under MIT (http://tameraydin.mit-license.org/)
 */
define(['angular', 'angular-animate', 'angular-sanitize'], function(angular) {
  'use strict';
            ...
            '<div class="ng-toast ng-toast--{{hPos}} ng-toast--{{vPos}}">' +
              '<ul class="ng-toast__list">' +
                '<toast-message ng-repeat="message in messages" ' +
                  'message="message">' +
                  //add filter,edited by chenmingwei
                  '<span ng-bind-html="message.content | to_trusted"></span>' +
                '</toast-message>' +
              '</ul>' +
            '</div>',
